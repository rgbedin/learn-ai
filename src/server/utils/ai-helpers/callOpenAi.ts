...
export async function callOpenAi(
  ...
  const maxTokens = DEFAULT_AI_MODEL_MAX_TOKENS - tokens - 10;

  console.debug("Calling OpenAI w/", tokens, "tokens estimated", { maxTokens });
  ...
  const estimatedPricing =
    (inputTokens / 1000) * DEFAULT_AI_MODEL_PRICE_PER_1000_INPUT +
    (outputTokens / 1000) * DEFAULT_AI_MODEL_PRICE_PER_1000_INPUT;
